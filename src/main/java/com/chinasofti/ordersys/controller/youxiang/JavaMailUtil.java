...
public class JavaMailUtil {
	...
	// 发件人的邮箱-修改为自己的
	public static String emailAccount = "2776730798@qq.com";
	// 发件人邮箱授权码-修改为自己的
	public static String emailPassword = "uofdhwikyznnddad";
	// 发件人邮箱服务地址-修改为自己的
	 ...
	 * To:发送
	 */
	public static  MimeMessage creatMimeMessage(Session session,String sendMail,String receiveMail,String html) throws MessagingException, IOException, javax.mail.MessagingException {
		// 1、创建一封邮件对象
