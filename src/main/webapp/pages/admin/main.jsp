	...
	function showOrder(responseTxt, obj) {
		...
		if (responseTxt != "Org_EricYang_Platform_ErrorMsg:ServerPush_Wait_TimeOut") {
			...
			var newLine = "<tr><td>" + tableId + "</td><td>" + orderBeginDate
					...
					+ "</td>";
			newLine += "<td>";
			newLine +="<a href='http://localhost:8080/pages/pay/index.jsp'";
							...
							<table class="table table-striped">
								...
								<tbody id="orderTable">
									<tr>
										...
										<td>ipsum</td>
										<td>dolor</td>
										<td><a href="http://localhost:8080/pages/pay/index.jsp"><i style="cursor: pointer; font-size: 14;"
													 onmouseover="this.style.color='orange'"
													 onmouseout="this.style.color='black'"
												 class="icon-credit-card icon-large" title="确认结账"></i></a>&nbsp;&nbsp;<i
