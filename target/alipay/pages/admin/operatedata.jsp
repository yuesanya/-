        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle"
                        ...
                        src="img/faces/${USER_INFO.faceimg }" width="24"
                        height="24"
                    ...
                    <ul class="dropdown-menu">
                        <li style="text-align: center;padding-top: 15px"><img
                                src="img/faces/${USER_INFO.faceimg }"
            ...
            <form class="navbar-form navbar-right" method="post"
                ...
                <iframe name="formtarget" width="0" height="0"
        ...
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a href="tooperatedata.order"><i
                        class="icon-bar-chart icon-large"></i>&nbsp;查看经营数据 </a>
                </li>
                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td><i style="cursor: pointer; font-size: 14px;"
                                       ...
                                       class="icon-credit-card icon-large"
                                       title="确认结账"></i>&nbsp;&nbsp;<i
                                        style="cursor: pointer; font-size: 14px;"
                                        onmouseover="this.style.color='orange'"
                                        onmouseout="this.style.color='black'"
                                        class="icon-sitemap icon-large"
                                        title="查看订单详情"
                                    ...
                                    &nbsp;&nbsp;<i
                                            ...
                                            onmouseover="this.style.color='orange'"
                                            onmouseout="this.style.color='black'"
                                            class=" icon-remove-sign icon-large"
                                            title="订单作废"
                    ...
                    <div class="row-fluid">
                        <div class="span6" style="width:30%;float:left">
                            <div
                                ...
                                <h2 style="color: white;font-weight: bold;font-family: 微软雅黑">
                                    桌号</h2>
                                <p id="tableId">101</p>
